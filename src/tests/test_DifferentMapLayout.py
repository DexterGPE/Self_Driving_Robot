...
class TestDifferentMapLayout(unittest.TestCase):
    ...
    def test_smooth_left_turn_on_bridge(self):
        pars = {"standard_speed": -30, "bridgesmoothness": 2 , "turn_speed": -16, "smoothness": 5, "turn_factor":1.6}
        left_speed, right_speed = -30, -30
        left_speed_result, right_speed_result = DifferentMapLayout.smooth_left_turn_on_bridge(left_speed, right_speed, pars)
    ...
    def test_smooth_right_turn_on_bridge(self):
        pars = {"standard_speed": -30, "bridgesmoothness": 2 , "turn_speed": -16, "smoothness": 5, "turn_factor":1.6}
        left_speed, right_speed = -30, -30
        left_speed_result, right_speed_result = DifferentMapLayout.smooth_right_turn_on_bridge(left_speed, right_speed, pars)
