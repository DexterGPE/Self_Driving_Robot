...
if __name__ == "__main__":
    ...
    while running:
        ...
        if key_states["mode"] == 0:
            ...
            speed_left, speed_right, wall_finding, time_since_black_line, key_states["mode"] = Smooth_Operator.self_driving(
                bp,speed_left, speed_right, wall_finding, time_since_black_line, 5, 2.2, -30, 15, 18, key_states["mode"])
            ...
            speed_left, speed_right, wall_finding, time_since_black_line, key_states["mode"] = Smooth_Operator.self_driving(
                bp,speed_left, speed_right, wall_finding, time_since_black_line, 5, 2.4, -30, 40, 18, key_states["mode"])
